...
//echo $nome;
		...
		//Obter o nome da Jogadora
			...
			$nome = $row["name"];			
		//Querys dos Serviços
			$aut="SELECT COUNT(*) AS quanto FROM service WHERE id_service_type=5 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$valor5 = $row["quanto"];
		
			$aut="SELECT COUNT(*) AS quanto FROM service WHERE id_service_type=4 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$valor4 = $row["quanto"];
		
			$aut="SELECT COUNT(*) AS quanto FROM service WHERE id_service_type=3 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$valor3 = $row["quanto"];
		
			$aut="SELECT COUNT(*) AS quanto FROM service WHERE id_service_type=2 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$valor2 = $row["quanto"];
		
			$aut="SELECT COUNT(*) AS quanto FROM service WHERE id_service_type=1 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$valor1 = $row["quanto"];
		//Querys dos Blocos
			$aut="SELECT COUNT(*) AS quanto FROM block WHERE id_block_type=1 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$bloco1 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM block WHERE id_block_type=2 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$bloco2 = $row["quanto"];
		//Query dos Ataques
			$aut="SELECT COUNT(*) AS quanto FROM attack WHERE id_attack_type=1 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$ataque1 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM attack WHERE id_attack_type=2 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$ataque2 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM attack WHERE id_attack_type=3 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$ataque3 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM attack WHERE id_attack_type=4 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$ataque4 = $row["quanto"];
		//Querys das Defesas
			$aut="SELECT COUNT(*) AS quanto FROM defence WHERE id_defence_type=1 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$defesa1 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM defence WHERE id_defence_type=2 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$defesa2 = $row["quanto"];
		//Querys das Recepções
			$aut="SELECT COUNT(*) AS quanto FROM reception WHERE id_reception_type=1 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$rececao1 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM reception WHERE id_reception_type=2 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$rececao2 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM reception WHERE id_reception_type=3 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$rececao3 = $row["quanto"];
			
			$aut="SELECT COUNT(*) AS quanto FROM reception WHERE id_reception_type=4 AND athlete='$variavel'";
			$resultado = mysql_query($aut,$ligacao);
			$row = mysql_fetch_assoc($resultado);
			$rececao4 = $row["quanto"];
?>
...
<h1 class="page-title">Estatísticas de <?php echo $nome ?></h1>
<center>
