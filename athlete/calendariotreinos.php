...
<section id="content" class="container clearfix">
	...
	<section id="main" >
		...
		<h2 class="slogan align-center"> Calendário de Treinos </h2>	
		<center><table border='1' width='65%' >
			...
			<?php
				...
				if ($todaysDate == $dateToCompare){
					...
					$sqlCount = "select * from training where date='".$dateToCompare2."'";
	...
	<?php
			...
			$sqlEvent = "select * from training where date='".$year."/".$month."/".$day."'";
			$resultEvents = mysql_query($sqlEvent);
			echo "<hr>";
			while($events = mysql_fetch_array($resultEvents)){
				$cate = $events['category'];
				
				$expressao = "SELECT * FROM category WHERE id_category = '$cate' ";
					$resultado = mysql_query($expressao);
				    while ($registo = mysql_fetch_array($resultado)){ 
					$namet1 = $registo["description"]; }
				
				echo "Abaixo seguem os detalhes do treino do dia &nbsp; ".$events['date'];
				echo "<br>";
				echo "<br><b>Tipo de Treino:</b> &nbsp; " .$events['type_training']."<br>";
				echo "<br>";
				echo "<br><b>Escalão:</b>  &nbsp;" .$namet1."<br>";
				echo "<br>";
				echo "<br><b>Descrição:</b>  &nbsp;" .$events['description']."<br>";
				echo "<br>";
				echo "<br><b>Duração:</b>  &nbsp;" .$events['duration']."<br>";
