...
<section id="content" class="container clearfix">
	...
	<?php $utilizador = $_SESSION['username']; ?>
		<h1 class="page-title">Próximos jogos do S.C.Braga:</h1>
...
$cat = "SELECT * from category WHERE id_category = '$cate'";
			$result2 = mysql_query($cat);
				while ($result3 = mysql_fetch_array($result2)){
				$namet3 = $result3["description"];				}
 ...
 echo "<tr align='center'>";
   echo "<td>" . $row['date'] . "</td>";
   echo "<td>" . $row['time'] . "</td>";
     echo "<td>".$namet1. "&nbsp".$x."&nbsp".$namet2."</td>";
	echo "<td>". $row['name_competition'] ."</td>";	 // set up a row for each record
