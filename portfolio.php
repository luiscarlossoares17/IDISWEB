...
<section id="content" class="container clearfix">
	...
	<section id="portfolio-items" class="clearfix">
		...
		<article class="one-fourth" data-categories="gestao">
			...
			<a href="testegrafico.php" class="project-meta" title="Francisca Lima - Gestora de Projeto">
				<img src="img/idis/fl.png" alt="">
			</a>

			<a href="testegrafico.php" class="project-meta">
		...
		<article class="one-fourth" data-categories="gestao">
			...
			<a href="img/idis/ec.png" class="single-image" title="Francisca Lima - Gestora de Projeto">
				<img src="img/idis/ec.png" alt="">
			</a>

			<a href="single-project.php" class="project-meta">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="../_media/smartstart-html/portfolio/snowtower-full.jpg" class="single-image" title="Snow Tower - ">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="../_media/smartstart-html/portfolio/nottheend-full.jpg" class="single-image" title="Not the end - The beginning of the end.">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="http://www.sapo.pt" class="iframe video" title="Shift - Abstract animation using Modo &amp; After Effects.">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="../_media/smartstart-html/portfolio/synergy-full.jpg" class="single-image" title="Synergy - The name says it all.">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="../_media/smartstart-html/portfolio/thegame-full.jpg" class="single-image" title="The Game - Canon 5D Canon 28mm f/2.8 Studio Shot.">
		...
		<article class="one-fourth" data-categories="prog">
			...
			<a href="../_media/smartstart-html/portfolio/tranton-full.jpg" class="single-image" title="Trantor - planet city">
		...
		<article class="one-fourth" data-categories="ana">
			...
			<a href="../_media/smartstart-html/portfolio/futurisk-full.jpg" class="single-image" title="Futurisk - ">
		...
		<article class="one-fourth" data-categories="ana">
			...
			<a href="../_media/smartstart-html/portfolio/forrst-full.jpg" class="single-image" title="Forrst Android App UI Design Mockups - UI design for a Forrst Android App concept.">
		...
		<article class="one-fourth" data-categories="ana">
			...
			<a href="../_media/smartstart-html/portfolio/forbiddenwords-full.jpg" class="single-image" title="Forbidden Words - ">
