...
<section id="content" class="container clearfix">
	...
	<header class="page-header">
		...
		<h1 class="page-title">Plantel Junior</h1>
	...
	<section id="portfolio-items" class="clearfix">
		...
		<!-- INICIO DO CICLO -->
		<?php
		$aut="SELECT * FROM athlete WHERE id_athlete IN (SELECT athlete FROM registration_form WHERE category = 2)";
		...
		<article class="one-fourth" data-categories="illustration design">
			...
			<a href="dadosjogadora.php?varname=<?php echo $id ?>" class="iframe video"  title="Perfil Completo de <?php echo $nome ?>">
