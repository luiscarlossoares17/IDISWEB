...
<section id="content" class="container clearfix">
	...
	<header class="page-header">
		...
		<h1 class="page-title">Área de Alteração de noticias:</h1>
			<p>Aqui podera alterar as suas noticias <p>
...
$_GET["id"];
$noticia = $_GET["id"];
$expressao = "SELECT * FROM news WHERE id = '$noticia'  ";
    $resultado = mysql_query($expressao);
      while ($registo = mysql_fetch_array($resultado)){ 
		$id2 = $registo["id"];
		$title2 = $registo["title"];
	  	$date2 = $registo["date"];
		$content2 = $registo["content"];
	

										
       } ?>
	     <form action="validaralteracaonoticia.php" method ="POST"> 
			<div class="form_settings">
			<br><span>ID: <input readonly type="text" name="id3" value="<?php echo $id2; ?>">
			<br><span>Titulo:<input type="text" name="title3" value="<?php echo $title2; ?>">
			<br><span>Data:<input type="Date" name="date3" value="<?php echo $date2; ?>">
			<br><span>Noticia:<textarea name="content3"><?php echo $content2;?></textarea>
