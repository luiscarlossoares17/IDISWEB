...
<section id="content" class="container clearfix">
	...
	<header class="page-header">
		...
		<h1 class="page-title">Notas das Jogadoras</h1>
	...
	<section id="portfolio-items" class="clearfix">
		...
		<article class="one-fourth" data-categories="illustration design">
			...
			<a href="gradesjogadoras.php?varname=<?php echo $id ?>" class="iframe video"  title="Perfil de <?php echo $nome ?>">
				<img src="../img/equipasenior/<?php echo "$id" ?>.png" alt="">
			</a>

			<a href="gradesjogadorasinsere.php?varname=<?php echo $id ?>" class="project-meta">
