...
<section id="content" class="container clearfix">
	...
	<?php $utilizador = $_SESSION['username']; ?>
		<h1 class="page-title">Noticias do S.C.Braga:</h1>
			<p>Caro <?php echo $utilizador?>, abaixo segue a lista das noticias registadas.  <p>
			<p>Clique <a href='registonoticias.php'>aqui</a> para inserir uma nova noticia <p>
...
$result = mysql_query('SELECT * FROM news');
 ...
 echo "<tr align='center'>";
   ...
   echo "<td>" . $row['content'] . "</td>";
     echo "<td>" . $row['date'] . "</td>";
	echo "<td><a href='verDadosNoticia.php?id=$id'>Consultar</a> - <a href='alterarnoticia.php?id=$id'>Alterar</a></td>";	 // set up a row for each record
}
