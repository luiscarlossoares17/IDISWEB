...
<section id="content" class="container clearfix">
	...
	<header class="page-header">
		...
		<h1 class="page-title">Registo de novas noticias</h1>
			<p>Insira os dados da noticia no formulário abaixo: <p>
	</header><!-- end .page-header -->
	
	<section id="main" >
	
	
		<form action="validarinserirnoticia.php" method="post">
          <div class="form_settings">
            <p><span>Titulo:</span><input type="text" name="title" value="" required/></p>
			<p><span>Data:</span><input type="Date" name="date" value="" required/></p>
			<p><span>Noticia:</span><textarea name="content" required></textarea></p>
			
	        
            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="name" value="Registar" /></p>
          </div>
        </form>
