    ...
    $resultado = mysql_query($expressao);
      while ($registo = mysql_fetch_array($resultado)){ 
		...
		$jersey2 = $registo["jersey_number"];
	     ...
	     <form action="listarjogadores.php" method ="POST"> 
			<div class="form_settings">
			<br><span>ID: <input readonly type="text" name="id3" value="<?php echo $idplayer2; ?>">
			<br><span>Nome:<input readonly type="text" name="nome3" value="<?php echo $name2; ?>">
			<br><span>Username:<input readonly type="text" name="user3" value="<?php echo $user2; ?>">
			<br><span>Password:<input readonly type="text" name="pass3" value="<?php echo $pass2; ?>">
			<br><span>Data de Nascimento:<input readonly type="Date" name="data3" value="<?php echo $birth2; ?>">
			<br><span>Morada:<input readonly type="text" name="morada3" value="<?php echo $address2; ?>">
			<br><span>Altura:<input readonly type="float" name="altura3" value="<?php echo $height2; ?>">
			<br><span>Peso:<input readonly type="float" name="peso3" value="<?php echo $weight2; ?>">
			<br><span>Email:<input readonly type="text" name="email3" value="<?php echo $email2; ?>">
			<br><span>Fotografia:<input readonly type="text" name="foto3" value="<?php echo $photo2; ?>">
			<br><span>Telefone:<input readonly type="integer" name="telefone3" value="<?php echo $phone_number2; ?>">
			<br><span>Genero:<input readonly type="text" name="genero3" value="<?php echo $gender2; ?>">
			<br><span>Estado:<input readonly type="integer" name="ative3" value="<?php echo $active2; ?>">
			<br><span>Descricao:<input readonly type="textarea" name="descricao3" value="<?php echo $descricao2; ?>">
			<br><span>Numero Segurança Social:<input readonly type="integer" name="niss3" value="<?php echo $niss2; ?>">
			<br><span>Numero Cartao Cidadao:<input readonly type="integer" name="cc3" value="<?php echo $num_cc2; ?>">
			<br><span>Numero Saude:<input readonly type="integer" name="health3" value="<?php echo $num_health2; ?>">
			...
			<br><span>Equipa:<input readonly type="text" name="team3" value="<?php echo $team2; ?>">
			<br><span>Grupo Sanguineo:<input readonly type="text" name="blood3" value="<?php echo $blood2; ?>">
