...
<section id="content" class="container clearfix">
	...
	<header class="page-header">
		...
		<h1 class="page-title">Área de Visualizacao de noticias:</h1>
			<p>Abaixo apresentamos os dados da noticia! <p>
...
$_GET["id"];
$noticia = $_GET["id"];
$expressao = "SELECT * FROM news WHERE id_news = '$noticia'  ";
      ...
      while ($registo = mysql_fetch_array($resultado)){ 
		...
		$content2 = $registo["content"];
	     ...
	     <form action="noticias.php" method ="POST"> 
			...
			<br><span>Titulo:<input readonly type="text" name="nome3" value="<?php echo $title2; ?>">
			<br><span>Data:<input readonly type="Date" name="user3" value="<?php echo $date2; ?>">
			<br><span>Noticia:<textarea readonly name="comment"><?php echo $content2; ?></textarea>
